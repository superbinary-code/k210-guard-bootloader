...
#ifndef __INCLUDE_OTP_H_
#define __INCLUDE_OTP_H_
...
/* clang-format off */
#define OTP_COMMON_DATA_ADDR	0x00000000// 0x00000000(bit)
#define OTP_SYSTEM_DATA_ADDR	0x00003AD0// 0x0001D680(bit)
#define OTP_BISR_DATA_ADDR	0x00003DD0// 0x0001EE80(bit)
#define OTP_BLOCK_CTL_ADDR	0x00003FD0// 0x0001FE80(bit)
#define OTP_WIRED_REG_ADDR	0x00003FE0// 0x0001FF00(bit)
#define OTP_AES_KEY_ADDR	0x00003FF0// 0x0001FF80(bit)

#define OTP_BUSY_FLAG		0x00000001
#define OTP_BYPASS_FLAG		0x00000002
#define OTP_TEST_FLAG		0x00000004
/* clang-format on */
...
enum otp_status_t {
	...
	OTP_WIRED_REG_UNSET, // function available
	OTP_WIRED_REG_SET, // function unavailable
...
enum otp_func_reg_t {
	...
	RAM_BISR_DISABLE = 1,
	AES_WRITE_DISABLE = 2,
	AES_VERIFY_DISABLE = 3,
	JTAG_DISABLE = 4,
	I2C2AXI_DISABLE = 5,
	TEST_EN_DISABLE = 6,
	ISP_DISABLE = 7,
	OTP_FUNC_FIRMWARE_CIPHER_DISABLE = 8,
	CHECK_TRUSTED_SHA256_CHECKSUM_ENABLE = 9,

	TURBO_MODE_BOOT_SPI0 = 61, // boot from SPI0 when disabled it
	TURBO_MODE_AUTO_DETECT_FLASH_ENABLE =
		62, // autodetect flash type in turbo mode
	TURBO_MODE_ENABLE = 63,
	FUNC_REG_MAX = 64,
};
...
/**
 * @brief      Refresh the function status
 *
 * @param[in]  reg	The specified function
 *
 * @return     Results of the operation
